    ...
    <div class="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
      ...
      >
        ...
        <div class="px-4 w-auto md:w-5/12 flex-1">
          <div class="">
            <h6 class="font-semibold text-lg md:text-xl leading-8">Pasific</h6>
      ...
      >
        ...
        <div class="px-4 w-auto md:w-5/12 flex-none md:flex-1 hidden md:block">
          <div class="">
            <h6 class="font-semibold text-lg">IDR 12.000.000</h6>
          </div>
        </div>
        <div class="px-4 w-2/12">
          <div class="text-center">
      ...
      >
        ...
        <div class="px-4 w-auto md:w-5/12 flex-none md:flex-1 hidden md:block">
          <div class="">
            <h6 class="font-semibold text-lg">IDR 20.000.000</h6>
          </div>
        </div>
        <div class="px-4 w-2/12">
          <div class="text-center">
